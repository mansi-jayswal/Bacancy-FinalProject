  ...
  return (
    <div className="max-w-4xl mx-auto mt-8">
      ...
      <div className="flex justify-between text-gray-600 mb-4">
        ...
        <div>
          <p><span className="font-bold"><FaHeart /></span> {recipe.likesCount}</p>
          <p><span className="font-bold"><FaUser /></span> {recipe.authorName}</p>
        </div>
      </div>
      <img src={recipe.img} alt={recipe.title} className="w-full rounded-lg mb-4" />
